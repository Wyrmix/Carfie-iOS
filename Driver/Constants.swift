...
struct Constants {
    ...
    let walkthroughWelcome = "Welcome Drivers, Espy is your newest rideshare Driver App."
    let walkthroughDrive = "Start driving your clients today! Go the distance and build your clients trusted and usage!"
    let walkthroughEarn = "Drive at your own Schedule and earn as much as you want when you want weekly! Thank you for being an Espy Driver"
    ...
    let PleaseAddOnlyDebitcard = "Please add only debit card"
...
//MARK:- yourTrip Page
    ...
    let bookedAnyRides = "You haven't booked any rides yet."
