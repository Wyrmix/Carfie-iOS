...
extension UIColor {
    ...
    static var primary : UIColor {
        return #colorLiteral(red: 0.1725490196, green: 0.6549019608, blue: 0.9176470588, alpha: 1) //UIColor(red: 149/255, green: 117/255, blue: 205/255, alpha: 1)
    }
    
    // Secondary Color
    static var secondary : UIColor {
        return #colorLiteral(red: 0.1725490196, green: 0.6549019608, blue: 0.9176470588, alpha: 1) //UIColor(red: 238/255, green: 98/255, blue: 145/255, alpha: 1)
    }
